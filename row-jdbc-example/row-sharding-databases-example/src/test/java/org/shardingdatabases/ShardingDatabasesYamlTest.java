 ...
 * @date : 2021/1/4 9:52
 */
public class ShardingDatabasesYamlTest {

    private final ShardingType SHARDING_DATABASES = ShardingType.SHARDING_DATABASES;
    private UserService userService;

    @Before
    public void init() throws IOException, SQLException {
        DataSource dataSource = YamlDataSourceFactory.newInstance(SHARDING_DATABASES, "/META-INF/sharding-databases.yml");
