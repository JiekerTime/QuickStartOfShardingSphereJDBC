 ...
 * @date : 2021/1/4 9:52
 */
public class ShardingReplicaQueryYamlTest {
    ...
    public void init() throws IOException, SQLException {
        DataSource dataSource = YamlDataSourceFactory.newInstance(SHARDING_DATABASES_AND_TABLES, "/META-INF/sharding-replica-query.yml");
