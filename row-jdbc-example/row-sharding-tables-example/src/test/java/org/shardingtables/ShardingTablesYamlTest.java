 ...
 * @date : 2021/1/4 9:52
 */
public class ShardingTablesYamlTest {

    private final ShardingType SHARDING_TABLES = ShardingType.SHARDING_TABLES;
    private UserService userService;

    @Before
    public void init() throws IOException, SQLException {
        DataSource dataSource = YamlDataSourceFactory.newInstance(SHARDING_TABLES, "/META-INF/sharding-tables.yml");
