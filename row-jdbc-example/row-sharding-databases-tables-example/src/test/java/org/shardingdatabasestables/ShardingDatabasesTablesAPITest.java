...
import org.shardingdatabasestables.config.ShardingDatabasesTablesConfig;
 ...
 * @date : 2021/1/4 10:57
 */
public class ShardingDatabasesTablesAPITest {
    ...
    public void init() throws IOException, SQLException {
        DataSource dataSource = ShardingDatabasesTablesConfig.getDataSource();
